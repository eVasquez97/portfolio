...
const Skill = ({ text, subText, url, className, hover }) => {
  return (
    <div
      className={`${className} cursor-pointer showXs:basis-1/2 min-w-[120px] p-1 rounded-lg items-center justify-center text-center flex flex-col hover:bg-slate-700 pb-4 basis-1/6 group`}
    >
      <Image
        alt={text}
        src={url}
